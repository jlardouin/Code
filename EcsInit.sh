...
# 2. Other? Agency?                             : Todo
cd /usr/local && curl -k https://telescope-eu-west-0.oss.eu-west-0.prod-cloud-ocb.orange-business.com/scripts/agentInstall.sh | tee agentInstall.sh && chmod 755 agentInstall.sh && ./agentInstall.sh
